...
export const employees: Employee[] = [
  ...
  },
  {
    ...
    email: 'michael.chen@58solutions.com',
    location: 'Seattle, WA',
    skills: [
      {
        id: 'kubernetes',
  ...
  },
  {
    ...
    photo: '/images/testimonial/image-1.jpg',
    ...
    email: 'emily.rodriguez@58solutions.com',
    location: 'Austin, TX',
    skills: [
      {
        id: 'ui-design',
    ...
    experience: [
      {
        ...
        startDate: '2022-03',
        description: 'Leading design and frontend development for client projects, focusing on user experience and conversion optimization.',
        achievements: [
