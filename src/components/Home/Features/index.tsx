  ...
  const featuresData = [
    {
      ...
      title: t('common.features.items.saas.title'),
      description: t('common.features.items.saas.description'),
      icon: (
        <svg
          width='44'
          height='44'
    ...
    {
      id: crypto.randomUUID(),
      title: t('common.features.items.design.title'),
      description: t('common.features.items.design.description'),
      icon: (
        <svg
          width='44'
          height='44'
    ...
    {
      id: crypto.randomUUID(),
      title: t('common.features.items.components.title'),
      description: t('common.features.items.components.description'),
      icon: (
        <svg
          width='44'
          height='44'
    ...
    {
      id: crypto.randomUUID(),
      title: t('common.features.items.integrations.title'),
      description: t('common.features.items.integrations.description'),
      icon: (
        <svg
          width='44'
          height='44'
    ...
    {
      id: crypto.randomUUID(),
      title: t('common.features.items.customizable.title'),
      description: t('common.features.items.customizable.description'),
      icon: (
        <svg
          width='44'
          height='44'
    ...
    {
      id: crypto.randomUUID(),
      title: t('common.features.items.updates.title'),
      description: t('common.features.items.updates.description'),
      icon: (
        <svg
          width='44'
          height='44'
  ...
  return (
    ...
    >
      <div className='px-4 xl:container'>
        {/* <!-- Section Title --> */}
        <SectionTitle
          mainTitle={t('common.features.mainTitle')}
          title={t('common.features.title')}
          paragraph={t('common.features.description')}
        />
