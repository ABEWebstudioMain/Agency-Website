...
export default function Timeline() {
  ...
  const timelineSteps = [
    {
      ...
      painPoint: {
        ...
        description:
          "Large consultancies schedule meeting after meeting, extending the 'discovery phase' for weeks without clear deliverables or progress.",
        icon: (
      ...
      solution: {
        ...
        description:
          "We start with a focused 2-day assessment and deliver a clear roadmap with defined milestones, timelines, and deliverables.",
        icon: (
    ...
    },
    {
      ...
      painPoint: {
        ...
        description:
          "Status reports filled with jargon and percentages that don't reflect real progress or tangible outcomes.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-orange-600">
      ...
      solution: {
        ...
        description:
          "Live demonstrations of working features every week, with clear metrics and direct access to the development team.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-primary">
    ...
    },
    {
      ...
      painPoint: {
        ...
        description:
          "Unexpected charges appear as 'additional requirements' that should have been included in the original scope.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-orange-600">
      ...
      solution: {
        ...
        description:
          "All costs defined upfront with detailed breakdowns. No surprises, no hidden fees, and clear change request processes.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-primary">
    ...
    },
    {
      ...
      painPoint: {
        ...
        description:
          "Senior consultants disappear after the sale, leaving junior developers to handle complex implementation challenges.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-orange-600">
      ...
      solution: {
        ...
        description:
          "The same senior specialists who design your solution also implement it, ensuring consistency and deep understanding throughout.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-primary">
    ...
    },
    {
      ...
      painPoint: {
        ...
        description:
          "Original timelines become distant memories as launch dates slip with technical excuses and blame-shifting.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-orange-600">
      ...
      solution: {
        ...
        description:
          "Agile sprints with working software delivered every 2 weeks. You see progress continuously, not just at the end.",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-primary">
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const scrollStart = -sectionTop + winH * 0.2;
      const scrollEnd = Math.max(1, sectionHeight - winH * 0.8);
  ...
  // One consistent % for line fill and ball position; cap to leave space for CTA
  const progressPct = Math.min(scrollProgress * 85, 85);
  ...
  return (
    <section ref={timelineRef} className="relative py-16 sm:py-20 lg:py-[100px] overflow-hidden">
      <div className="px-4 xl:container">
        ...
        {/* isolate => predictable stacking; background at z-0, content ≥ z-10 */}
        <div className="relative mx-auto max-w-6xl isolate">
          {/* BACKGROUND: timeline line + progress + ball */}
          <div className="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
            <div
              className="absolute left-6 lg:left-1/2 top-0 lg:-translate-x-1/2 bg-stroke dark:bg-[#2E333D]"
              style={{ height: "calc(100% - 200px)", width: "1px" }}
            >
              <div
                className="absolute top-0 w-full bg-primary transition-[height] duration-200 ease-out will-change-[height]"
                style={{ height: `${progressPct}%` }}
              />
              <div
                className="absolute left-1/2 -translate-x-1/2 transition-[top] duration-200 ease-out will-change-[top]"
                style={{ top: `${progressPct}%` }}
              >
                <div className="relative">
                  {/* Remove this pulse if you want the dot even subtler near cards */}
                  <div className="absolute -inset-2 rounded-full bg-primary/20 animate-pulse" />
                  <div className="relative h-4 w-4 rounded-full bg-primary shadow-lg border-2 border-white dark:border-dark" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 space-y-16 lg:space-y-24">
            {timelineSteps.map((step, index) => (
              <div
                key={step.id}
                className={`relative pl-14 lg:pl-0 transition-all duration-500 ${
                  activeStep === index ? "opacity-100" : "opacity-75"
                }`}
              >
                {/* Time pill: left on mobile, centered on lg+ */}
                <div className="absolute left-6 lg:left-1/2 top-0 z-30 lg:-translate-x-1/2 -translate-y-1/2">
                  <div
                    className={`rounded-full px-3 py-1.5 lg:px-4 lg:py-2 font-heading text-xs lg:text-sm font-medium shadow-md transition-all duration-300 ${
                      activeStep >= index
                        ? "bg-primary text-white lg:scale-110"
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 lg:items-stretch">
                  ...
                  <div className="lg:text-right">
                    <div
                      className={`relative z-20 rounded-sm border-l-4 border-orange-400 bg-orange-50 p-6 transition-all duration-300 dark:bg-orange-900/10 lg:p-8 ${
                  ...
                  <div>
                    <div
                      className={`relative z-20 rounded-sm border-l-4 border-primary bg-primary/5 p-6 transition-all duration-300 dark:bg-primary/10 lg:p-8 ${
                        activeStep >= index
                          ? "shadow-md border-primary bg-primary/10 dark:bg-primary/15"
                          : "shadow-sm"
                      } h-full flex flex-col`}
                    >
          ...
          {/* Bottom CTA */}
          <div className="relative z-20 mt-32 text-center lg:mt-40 pt-12 pl-14 lg:pl-0">
