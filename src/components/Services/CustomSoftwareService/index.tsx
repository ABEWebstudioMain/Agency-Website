...
export default function CustomSoftwareService() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-white to-primary/10 pt-24 py-20 sm:py-24 lg:pt-32 lg:py-32 md:pt-28 dark:from-primary/10 dark:via-dark dark:to-primary/20">
